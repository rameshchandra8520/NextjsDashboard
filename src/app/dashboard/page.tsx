...
export default function DashboardHome() {
  ...
  return (
    <div className="space-y-6 animate-fadeIn">
          ...
          <div className="p-4 sm:p-5">
            <div className="flex items-center">
              ...
              <div className="ml-4 sm:ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Total Orders</dt>
                  <dd className="text-xl sm:text-3xl font-semibold text-gray-900 dark:text-white">{totalOrders}</dd>
                </dl>
              </div>
            </div>
          </div>
          <div className="bg-gray-50 dark:bg-gray-700/50 px-4 sm:px-5 py-2 sm:py-3">
        ...
        <div className="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg border border-gray-200 dark:border-gray-700">
          <div className="p-4 sm:p-5">
            <div className="flex items-center">
              ...
              <div className="ml-4 sm:ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Delivered</dt>
                  <dd className="text-xl sm:text-3xl font-semibold text-gray-900 dark:text-white">{deliveredOrders}</dd>
                </dl>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg border border-gray-200 dark:border-gray-700">
          <div className="p-4 sm:p-5">
            <div className="flex items-center">
              ...
              <div className="ml-4 sm:ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Pending</dt>
                  <dd className="text-xl sm:text-3xl font-semibold text-gray-900 dark:text-white">{pendingOrders}</dd>
                </dl>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-4 sm:ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-xl sm:text-3xl font-semibold text-gray-900 dark:text-white">{preparingOrders + outForDeliveryOrders}</dd>
                </dl>
              </div>
            </div>
          </div>
      ...
      <div className="bg-white dark:bg-gray-800 shadow overflow-hidden sm:rounded-lg">
        <div className="px-4 py-5 sm:p-6">
          <h2 className="text-base sm:text-lg font-medium text-gray-900 dark:text-white">Quick Info</h2>
          <div className="mt-4 text-xs sm:text-sm md:text-base text-gray-600 dark:text-gray-300">
            <p className="mb-2">
